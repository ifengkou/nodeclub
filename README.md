...
已在Node.js 中文技术社区 [CNode(http://cnodejs.org)](http://cnodejs.org) & ClickHouse 中文技术社区 [ClickHouseClub(http://www.clickhouse.com.cn)](http://www.clickhouse.com.cn)  ClickHouse 中文技术社区（备1） [ClickHouseClub(http://www.clickhouse.vip)](http://www.clickhouse.vip) 得到应用，但你完全可以用它搭建自己的社区。
...
5. `$ make build` & `$ make test` 确保各项服务都正常
6. `$ node app.js`
